...
bool ImGui_ImplAndroid_InitX(int32_t w, int32_t h)
{
    m_windowWidth = w;
    m_windowHeight = h;
  //  g_Window = window;
...
void ImGui_ImplAndroid_NewFrame()
{
    ...
    int32_t window_width = m_windowWidth;// ANativeWindow_getWidth(g_Window);
    int32_t window_height = m_windowHeight;// ANativeWindow_getHeight(g_Window);
