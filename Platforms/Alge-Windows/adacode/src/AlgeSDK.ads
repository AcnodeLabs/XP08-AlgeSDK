...
--   use GameObjects;
   ...
   procedure alPushP (cmd : int;
                      param1 : Strings.chars_ptr;
                      param2 : Strings.chars_ptr);
   procedure alBillBoardBegin;
   procedure alBillBoardEnd;
   procedure alLoadIdentity;
   procedure alPushMatrix;
   procedure alPopMatrix;
   procedure alaluLookAt (x1 : C_float; y1 : C_float; z1 : C_float;
   ...
   procedure alLoadModel (alx : Strings.chars_ptr; tga : Strings.chars_ptr;
                          id : int; size : C_float);
   procedure alDrawModel (id : int);
   procedure alScaleModel (id : int; sx : C_float; sy : C_float; sz : C_float);
   --  0=>unset ; 1=>set GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA
   procedure alAlphaTest (enable : int; fA : C_float := 0.4);
   function alModelBounds (id : int) return Float;
   procedure alDrawModelTranslateRotate (
            id : int;
            posx : C_float := 0.0; posy : C_float := 0.0;
            posz : C_float := 0.0;
            angle : C_float := 0.0; x : C_float := 0.0;
            y : C_float := 0.0; z : C_float := 0.0;
